...
export const P = {
  ...
  bg: '#0a0c12',
  grid: '#11141d',
  // 区域各自的地面色。荒野不在这儿：基准区域用 grid 本身，一个字节都不改
  ground: {
    marsh: '#0f1a17',
    lair: '#171124',
    snow: '#131b26',
  },
  // 视差远景那层斑点。它画在区域色调之下，所以会被色调染上当前区域的颜色
  dust: '#1e2434',
  ...
  // 0.07 时几乎看不出来（试玩反馈"换区只有 HUD 文字告诉我"），提到 0.11
  zoneTint: {
    marsh: 'rgba(60,120,90,0.11)',
    lair: 'rgba(120,70,140,0.11)',
    snow: 'rgba(150,175,205,0.11)',
  },
